...
const makeStyles = (colors) => StyleSheet.create({
  ...
  modeSelTxt: { color: colors.text, fontFamily: fonts.semibold, fontSize: 11.5 },
  modeDrop: {
    position: 'absolute', top: 0, left: 12, zIndex: 50, marginTop: 92,
    backgroundColor: colors.surface, borderWidth: 1, borderColor: colors.border,
    borderRadius: 12, padding: 4, width: 238,
    shadowColor: '#000', shadowOpacity: 0.3, shadowRadius: 12, shadowOffset: { width: 0, height: 6 }, elevation: 8,
  },
  dropLabel: { color: colors.muted, fontFamily: fonts.semibold, fontSize: 10, paddingHorizontal: 8, paddingTop: 5, paddingBottom: 2, textTransform: 'uppercase' },
  dropDivider: { height: 1, backgroundColor: colors.border, marginVertical: 3 },
  modeDropRow: { flexDirection: 'row', alignItems: 'center', gap: 8, padding: 8, borderRadius: 9 },
  modeDropOn: { backgroundColor: colors.card },
  modeDropTitle: { color: colors.text, fontFamily: fonts.semibold, fontSize: 13 },
  modeDropSub: { color: colors.muted, fontFamily: fonts.regular, fontSize: 10.5, marginTop: 1 },
